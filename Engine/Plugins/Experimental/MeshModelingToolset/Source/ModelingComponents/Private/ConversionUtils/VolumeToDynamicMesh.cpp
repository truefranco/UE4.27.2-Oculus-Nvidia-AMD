...
void BrushComponentToDynamicMesh(UBrushComponent* Component, FDynamicMesh3& Mesh, const FVolumeToMeshOptions& Options)
{
...
void BrushToDynamicMesh(UModel& BrushModel, FDynamicMesh3& Mesh, const FVolumeToMeshOptions& Options)
{
