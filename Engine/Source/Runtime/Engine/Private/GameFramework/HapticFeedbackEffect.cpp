...
static TAutoConsoleVariable<int32> CVarSoundwaveTargetFrequency(
	TEXT("r.Mobile.SoundwaveTargetFrequency"),
	320,
	TEXT("The target frequency of soundwave. Default is 320.\n"),
...
void UHapticFeedbackEffect_SoundWave::PrepareSoundWaveBuffer()
{
	...
	int TargetFrequency = CVarSoundwaveTargetFrequency.GetValueOnAnyThread();
