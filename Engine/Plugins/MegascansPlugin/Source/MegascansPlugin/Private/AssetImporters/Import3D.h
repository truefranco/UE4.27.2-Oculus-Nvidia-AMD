...
private:
	...
	void ImportNormal(TSharedPtr<FAssetTypeData> AssetImportData, TArray<UMaterialInstanceConstant*> MaterialInstance, TSharedPtr<ImportParams3DAsset> Asset3DParameters);
public:
