...
void FCreateMeshObjectParams::SetMesh(const FDynamicMesh3* DynamicMeshIn)
{
	DynamicMesh = *DynamicMeshIn;
	MeshType = ECreateMeshObjectSourceMeshType::DynamicMesh;
	if(DynamicMesh)
	{ 
		FNonManifoldMappingSupport::RemoveAllNonManifoldMappingData(*DynamicMesh);
	}
}

void FCreateMeshObjectParams::SetMesh(FDynamicMesh3&& DynamicMeshIn)
{
