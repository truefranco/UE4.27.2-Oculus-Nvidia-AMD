...
public:
	...
	TMap<USkeletalMeshComponent*, FCachedSkeletalMeshData> CachedSkeletalMeshDatas;
	...
	TMap<USkeletalMeshComponent*, FModifiedSkeletalMeshData> ModifiedSkeletalMeshDatas;
