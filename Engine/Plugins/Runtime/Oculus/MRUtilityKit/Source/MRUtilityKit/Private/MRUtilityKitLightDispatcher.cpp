...
AMRUKLightDispatcher::AMRUKLightDispatcher()
{
	...
	const ConstructorHelpers::FObjectFinder<UMaterialParameterCollection> MpcAsset(TEXT("/MRUtilityKit/Materials/MPC_Highlights"));
	...
	{
		UE_LOG(LogMRUK, Log, TEXT("Light dispatcher couldn't find material parameter collection in /MRUtilityKit/Materials/MPC_Highlights"));
	}
}
