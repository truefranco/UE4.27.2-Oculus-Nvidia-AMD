...
public:
	...
	/** Generate the mesh */
	GEOMETRICOBJECTS_API virtual FMeshShapeGenerator& Generate() override;

private:
	/** Generate solid style stairs */
	GEOMETRICOBJECTS_API FMeshShapeGenerator& GenerateSolidStairs();

	/** Generate floating style stairs */
	GEOMETRICOBJECTS_API FMeshShapeGenerator& GenerateFloatingStairs();
	 ...
	 * initialized.
	 */
	GEOMETRICOBJECTS_API ESide FaceToSide(int FaceId);
...
protected:
	...
	GEOMETRICOBJECTS_API virtual void ResetData();
...
protected:
	GEOMETRICOBJECTS_API virtual FVector3d GenerateVertex(ESide Side, int VertexColumn, int VertexRow) override;
	GEOMETRICOBJECTS_API virtual FVector3f GenerateNormal(ESide Side, int VertexId) override;
	GEOMETRICOBJECTS_API virtual FVector2f GenerateUV(ESide Side, int Step, int VertexId, float UVScale) override;
	GEOMETRICOBJECTS_API virtual float GetMaxDimension() override;
};
...
protected:
	GEOMETRICOBJECTS_API virtual void ResetData() override;
	GEOMETRICOBJECTS_API virtual FVector3d GenerateVertex(ESide Side, int VertexColumn, int VertexRow) override;
	GEOMETRICOBJECTS_API virtual FVector3f GenerateNormal(ESide Side, int VertexId) override;
	GEOMETRICOBJECTS_API virtual FVector2f GenerateUV(ESide Side, int Step, int VertexId, float UVScale) override;
	GEOMETRICOBJECTS_API virtual float GetMaxDimension() override;
