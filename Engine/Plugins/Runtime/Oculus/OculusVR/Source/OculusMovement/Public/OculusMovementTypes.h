...
UENUM(BlueprintType)
enum class EOculusBoneID : uint8
{
	BodyRoot = 0,
	BodyHips = 1,
	BodySpineLower = 2,
...
struct OCULUSMOVEMENT_API FOculusBodyJoint
{
	GENERATED_BODY()
public:
	FOculusBodyJoint();
...
USTRUCT(BlueprintType)
struct OCULUSMOVEMENT_API FOculusBodyState
{
	GENERATED_BODY()
public:
	FOculusBodyState();
	...
	UPROPERTY(BlueprintReadOnly, Category = "Oculus|Movement")
	TArray<FOculusBodyJoint> Joints;
};

UENUM(BlueprintType)
enum class EOculusFaceExpression : uint8
{
...
UENUM(BlueprintType)
enum class EOculusFaceConfidence : uint8
{
	Lower = 0,
	Upper = 1,
	COUNT = 2,
...
USTRUCT(BlueprintType)
struct OCULUSMOVEMENT_API FOculusFaceState
{
	GENERATED_BODY()
public:
	FOculusFaceState();
...
USTRUCT(BlueprintType)
struct OCULUSMOVEMENT_API FOculusEyeGazeState
{
	GENERATED_BODY()
public:
	FOculusEyeGazeState();
...
USTRUCT(BlueprintType)
struct OCULUSMOVEMENT_API FOculusEyeGazesState
{
	GENERATED_BODY()
public:
	FOculusEyeGazesState();

	UPROPERTY(BlueprintReadOnly, Category = "Oculus|Movement")
	TArray<FOculusEyeGazeState> EyeGazes;
