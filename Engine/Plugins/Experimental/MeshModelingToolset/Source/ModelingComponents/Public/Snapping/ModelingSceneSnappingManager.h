...
protected:
	...
	TSharedPtr<FSceneGeometrySpatialCache> SpatialCache;
	...
	TMap<UPrimitiveComponent*, TWeakObjectPtr<USimpleDynamicMeshComponent>> DynamicMeshComponents;
	void HandleDynamicMeshModifiedDelegate(USimpleDynamicMeshComponent* Component);

	// PauseSceneGeometryUpdates / UnPauseSceneGeometryUpdates support
	bool bQueueModifiedDynamicMeshUpdates = false;
	TSet<USimpleDynamicMeshComponent*> PendingModifiedDynamicMeshes;
};
