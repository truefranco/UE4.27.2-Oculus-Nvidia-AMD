...
public:
	...
	// Start libheapprofd_standalone_client.so at launch, creating another process for heapprofd/perfetto integration.
	UPROPERTY(GlobalConfig, EditAnywhere, Category = AdvancedBuild, meta = (DisplayName = "Package with libheapprofd for perfetto/heapprofd support. [Experimental]"))
	bool bPackageHeapprofd;
