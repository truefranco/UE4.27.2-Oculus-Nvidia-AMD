 ...
 */
void MODELINGCOMPONENTS_API GetPolygonFaces(const FDynamicMesh3& InputMesh, const FMeshToVolumeOptions& Options, 
 ...
 */
void MODELINGCOMPONENTS_API GetPolygonFaces(const FDynamicMesh3& InputMesh, TArray<FDynamicMeshFace>& Faces,
 ...
 */
void MODELINGCOMPONENTS_API GetTriangleFaces(const FDynamicMesh3& InputMesh, TArray<FDynamicMeshFace>& Faces);

/**
 * Converts a dynamic mesh to a volume.
 */
void MODELINGCOMPONENTS_API DynamicMeshToVolume(const FDynamicMesh3& InputMesh, AVolume* TargetVolume,
	const FMeshToVolumeOptions& Options = FMeshToVolumeOptions());
void MODELINGCOMPONENTS_API DynamicMeshToVolume(const FDynamicMesh3& InputMesh, TArray<FDynamicMeshFace>& Faces, AVolume* TargetVolume);
