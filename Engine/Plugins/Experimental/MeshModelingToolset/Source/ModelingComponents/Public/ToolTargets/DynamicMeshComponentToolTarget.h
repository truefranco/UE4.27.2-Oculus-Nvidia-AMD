 ...
 */
UCLASS(Transient)
class MODELINGCOMPONENTS_API UDynamicMeshComponentToolTarget :
...
public:
	...
	virtual void CommitDynamicMesh(const FDynamicMesh3& Mesh, const FDynamicMeshCommitInfo& CommitInfo) override;
	...
	virtual USimpleDynamicMeshComponent* GetDynamicMeshComponent() override;
...
UCLASS(Transient)
class MODELINGCOMPONENTS_API UDynamicMeshComponentToolTargetFactory : public UToolTargetFactory
{
	GENERATED_BODY()
