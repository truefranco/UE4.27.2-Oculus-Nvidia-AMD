 ...
 */
UCLASS(Transient)
class MODELINGCOMPONENTS_API UStaticMeshComponentToolTarget : public UPrimitiveComponentToolTarget,
...
UCLASS(Transient)
class MODELINGCOMPONENTS_API UStaticMeshComponentToolTargetFactory : public UToolTargetFactory
{
	GENERATED_BODY()
