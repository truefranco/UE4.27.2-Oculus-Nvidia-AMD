...
public:
	FORCEINLINE_DEBUGGABLE static FRasterizerStateRHIRef CreateRHI()
	{
		...
		FRasterizerStateRHIRef RasterizerStateRHIRef = PipelineStateCache::GetAndOrCreateRasterizerState(Initializer);
		return RasterizerStateRHIRef;
	}
};
...
public:
	static FDepthStencilStateRHIRef CreateRHI()
	{
		...
		FDepthStencilStateRHIRef DepthStencilStateRHIRef = PipelineStateCache::GetAndOrCreateDepthStencilState(Initializer);
		return DepthStencilStateRHIRef;
	}
};
...
public:
	static FBlendStateRHIRef CreateRHI()
	{
		...
		FBlendStateRHIRef BlendStateRHIRef = PipelineStateCache::GetAndOrCreateBlendState(FBlendStateInitializerRHI(RenderTargetBlendStates, bUseAlphaToCoverage));
