 ...
 */
UCLASS()
class MESHMODELINGTOOLS_API UPatternToolBuilder : public UMultiSelectionMeshEditingToolBuilder
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class MESHMODELINGTOOLS_API UPatternToolSettings : public UInteractiveToolPropertySet
{
	GENERATED_BODY()
public:
 ...
 */
UCLASS()
class MESHMODELINGTOOLS_API UPatternTool_BoundingBoxSettings : public UInteractiveToolPropertySet
{
	GENERATED_BODY()
public:
 ...
 */
UCLASS()
class MESHMODELINGTOOLS_API UPatternTool_LinearSettings : public UInteractiveToolPropertySet
{
	GENERATED_BODY()
public:
 ...
 */
UCLASS()
class MESHMODELINGTOOLS_API UPatternTool_GridSettings : public UInteractiveToolPropertySet
{
	GENERATED_BODY()
public:
 ...
 */
UCLASS()
class MESHMODELINGTOOLS_API UPatternTool_RadialSettings : public UInteractiveToolPropertySet
{
	GENERATED_BODY()
public:
 ...
 */
UCLASS()
class MESHMODELINGTOOLS_API UPatternTool_RotationSettings : public UInteractiveToolPropertySet
{
	GENERATED_BODY()
public:
 ...
 */
UCLASS()
class MESHMODELINGTOOLS_API UPatternTool_TranslationSettings : public UInteractiveToolPropertySet
{
	GENERATED_BODY()
public:
 ...
 */
UCLASS()
class MESHMODELINGTOOLS_API UPatternTool_ScaleSettings : public UInteractiveToolPropertySet
{
	GENERATED_BODY()
public:
 ...
 */
UCLASS()
class MESHMODELINGTOOLS_API UPatternTool_OutputSettings : public UInteractiveToolPropertySet
{
	GENERATED_BODY()
public:
 ...
 */
UCLASS()
class MESHMODELINGTOOLS_API UPatternTool : public UMultiSelectionMeshEditingTool
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY()
	UPatternTool_BoundingBoxSettings* BoundingBoxSettings;
...
protected:
	...
	UPROPERTY()
	UTransformProxy* PatternGizmoProxy = nullptr;

	UPROPERTY()
	UTransformGizmo* PatternGizmo = nullptr;
	...
	TArray<FTransform3d> CurrentPattern;
	...
	void GetPatternTransforms_Linear(TArray<FTransform3d>& TransformsOut);
	void GetPatternTransforms_Grid(TArray<FTransform3d>& TransformsOut);
	void GetPatternTransforms_Radial(TArray<FTransform3d>& TransformsOut);
	...
	struct FPatternElement
	{
		...
		FTransform3d SourceTransform = FTransform3d::Identity();
		FTransform3d BaseRotateScale = FTransform3d::Identity();

		// We don't need to store rotation or scale relative to first
		// element because that is handled by BaseRotateScale
		FVector3d RelativePosition = FVector3d::Zero();

		UDynamicMesh* SourceDynamicMesh = nullptr;
		UStaticMesh* SourceStaticMesh = nullptr;

		FAxisAlignedBox3d LocalBounds = FAxisAlignedBox3d::Empty();			// The unchanged bounding box of the source mesh. Only used indirectly through PatternBounds
		FAxisAlignedBox3d PatternBounds = FAxisAlignedBox3d::Empty();		// The bounding box used for computing CombinedPatternBounds for packed spacing. By default this box adapts to StartScale/StartRotation
	};
	TArray<FPatternElement> Elements;
	FAxisAlignedBox3d CombinedPatternBounds = FAxisAlignedBox3d::Empty();	// The bounding box that contains all of the elements' PatternBounds bounding boxes. Used for packed mode spacing
	...
	void ComputeBoundingBoxWithTransform(int32 ElemIdx, FAxisAlignedBox3d& BoundingBox, const FTransform3d& Transform);
...
protected:
	...
	USimpleDynamicMeshComponent* GetPreviewDynamicMesh(const FPatternElement& Element);
	...
	UPROPERTY()
	UPreviewGeometry* PreviewGeometry = nullptr;	// parent actor for all preview components
