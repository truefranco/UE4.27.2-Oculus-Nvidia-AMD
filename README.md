...
Welcome to the Oculus fork of Epic’s Unreal Engine. We recommend you use our fork whenever building apps for Oculus devices. In addition to the OVRPlugin, this fork contains features, samples, and fixes not yet available in Epic’s repo.
 
You can find the latest plugin release notes [here](https://developer.oculus.com/downloads/package/unreal-engine-4-integration/).
...
#### Samples
* [Samples/Oculus/](https://github.com/Oculus-VR/UnrealEngine/tree/4.27/Samples/Oculus)
...
1. Open your source folder in Explorer and run **Setup.bat**. 
   ...
   A clean download of the engine binaries is currently 12GiB, which may take some time to complete.
