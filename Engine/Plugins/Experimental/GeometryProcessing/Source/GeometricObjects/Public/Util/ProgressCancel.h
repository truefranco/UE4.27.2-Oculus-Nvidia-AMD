...
private:
	...
	GEOMETRICOBJECTS_API void StartWorkScope(FProgressData& SaveProgressFrameOut, float StepSize, const FText& Message);

	GEOMETRICOBJECTS_API void EndWorkScope(const FProgressData& SavedProgressFrame);
...
public:
	...
	public:
		 ...
		 */
		GEOMETRICOBJECTS_API FProgressScope(FProgressCancel* ProgressCancel, float ProgressAmount, const FText& Message = FText());
		 ...
		 */
		GEOMETRICOBJECTS_API void Done();
	 ...
	 */
	static GEOMETRICOBJECTS_API FProgressScope CreateScopeTo(FProgressCancel* ProgressCancel, float ProgressTo, const FText& Message = FText());
...
void FGeometryResult::SetSuccess(bool bSuccess, FProgressCancel* Progress)
{
...
void FGeometryResult::SetFailed(FText ErrorMessage, int ResultCode)
{
...
bool FGeometryResult::CheckAndSetCancelled(FProgressCancel* Progress)
{
	if (Progress && Progress->Cancelled())
	{
		Result = EGeometryResultType::Cancelled;
