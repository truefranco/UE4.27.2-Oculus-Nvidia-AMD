 ...
 */
UCLASS(Transient)
class INTERACTIVETOOLSFRAMEWORK_API USingleSelectionMeshEditingToolBuilder : public UInteractiveToolWithToolTargetsBuilder
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class INTERACTIVETOOLSFRAMEWORK_API USingleSelectionMeshEditingTool : public USingleSelectionTool
{
	GENERATED_BODY()
public:
