...
namespace VulkanRHI
{
	...
	static FORCEINLINE_DEBUGGABLE void  vkCmdBeginRenderPass2KHR(VkCommandBuffer CommandBuffer, const VkRenderPassBeginInfo* RenderPassBegin, VkSubpassBeginInfo* SubpassBegin)
	{
		VULKANAPINAMESPACE::vkCmdBeginRenderPass2KHR(CommandBuffer, RenderPassBegin, SubpassBegin);
	}
	...
	static FORCEINLINE_DEBUGGABLE void  vkCmdNextSubpass2KHR(VkCommandBuffer CommandBuffer, VkSubpassBeginInfo* SubpassBegin, VkSubpassEndInfo* SubpassEnd)
	{
		VULKANAPINAMESPACE::vkCmdNextSubpass2KHR(CommandBuffer, SubpassBegin, SubpassEnd);
	}
	...
	static FORCEINLINE_DEBUGGABLE void  vkCmdEndRenderPass2KHR(VkCommandBuffer CommandBuffer, VkSubpassEndInfo* SubpassEnd)
	{
		VULKANAPINAMESPACE::vkCmdEndRenderPass2KHR(CommandBuffer, SubpassEnd);
	}
