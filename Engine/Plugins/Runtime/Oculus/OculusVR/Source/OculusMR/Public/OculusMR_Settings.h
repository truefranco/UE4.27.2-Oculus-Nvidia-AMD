...
UENUM(BlueprintType)
enum class EOculusMR_CameraDeviceEnum_DEPRECATED : uint8
{
...
enum class EOculusMR_CompositionMethod : uint8
{
	...
	DirectComposition_DEPRECATED		UMETA(Hidden, DisplayName = "Direct Composition (Deprecated)")
};
...
public:
	...
	* hand movement by a small amount of time to match the camera latency */
	UPROPERTY(meta = (DeprecatedProperty, DeprecationMessage = "Direct Composition is deprecated."))
	...
	UFUNCTION(meta = (DeprecatedFunction, DeprecationMessage = "Direct Composition is deprecated."))
	EOculusMR_CameraDeviceEnum_DEPRECATED GetCapturingCamera() { return CapturingCamera_DEPRECATED; }

	/** When CompositionMethod is DirectComposition, the physical camera device which provide the frame */
	UFUNCTION(meta = (DeprecatedFunction, DeprecationMessage = "Direct Composition is deprecated."))
	void SetCapturingCamera(EOculusMR_CameraDeviceEnum_DEPRECATED val);
...
private:
	...
	/** When CompositionMethod is DirectComposition, the physical camera device which provide the frame */
	UPROPERTY(meta = (DeprecatedProperty, DeprecationMessage = "Direct Composition is deprecated."))
	EOculusMR_CameraDeviceEnum_DEPRECATED CapturingCamera_DEPRECATED;
