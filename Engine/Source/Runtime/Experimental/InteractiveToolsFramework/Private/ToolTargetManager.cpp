...
{
	UToolTargetFactory** Found = Factories.FindByPredicate(Predicate);
...
TArray<UToolTarget*> UToolTargetManager::BuildAllSelectedTargetable(const FToolBuilderState& SceneState,
