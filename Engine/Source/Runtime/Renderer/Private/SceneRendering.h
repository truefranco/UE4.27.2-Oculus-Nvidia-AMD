...
protected:
	...
	void PostRenderBasePass(FRHICommandListImmediate& RHICmdList);
	...
	void MobileTonemapSubpass(FRHICommandListImmediate& RHICmdList, bool bUseColorGradingLUT, const FViewInfo& View);

	/** Mobile Color Transform Subpass */
	void RenderColorTransform(FRHICommandListImmediate& RHICmdList);
	...
	// AppSpaceWarp
	void RenderForwardHmdMotionVectors(FRHICommandListImmediate& RHICmdList, FRHITexture* HmdMotionVectorTexture, FRHITexture* HmdMotionVectorDepthTexture, const TArrayView<const FViewInfo*> ViewList);
