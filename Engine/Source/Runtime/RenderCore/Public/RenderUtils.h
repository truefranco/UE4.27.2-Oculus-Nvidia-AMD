...
RENDERCORE_API bool IsMobileTonemapSubpassEnabled(const FStaticShaderPlatform Platform);
...
inline bool IsUsingGBuffers(const FStaticShaderPlatform Platform)
{
	...
	{
		return IsMobileDeferredShadingEnabled(Platform) || (GIsEditor && IsMobileTonemapSubpassEnabled(Platform));
	}
	else
	{
