...
DECLARE_DELEGATE_TwoParams(FOculusHMDEventPollingDelegate, ovrpEventDataBuffer*, bool&);
...
protected:
	...
	bool CheckEyeTrackingPermission(EFoveatedRenderingMethod FoveatedRenderingMethod);
...
public:
	...
	*/
	...
	void GetSuggestedCpuAndGpuPerformanceLevels(EProcessorPerformanceLevel& CpuPerfLevel, EProcessorPerformanceLevel& GpuPerfLevel);
	void SetSuggestedCpuAndGpuPerformanceLevels(EProcessorPerformanceLevel CpuPerfLevel, EProcessorPerformanceLevel GpuPerfLevel);
	...
	OCULUSHMD_API void AddEventPollingDelegate(const FOculusHMDEventPollingDelegate& NewDelegate);
...
protected:
	...
	std::atomic<EFoveatedRenderingMethod> FoveatedRenderingMethod;
	std::atomic<EFoveatedRenderingLevel> FoveatedRenderingLevel;
