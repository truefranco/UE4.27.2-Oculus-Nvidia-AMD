...
namespace PipelineStateCache
{
	...
	extern RHI_API FRHIBlendState*			GetAndOrCreateBlendState(const FBlendStateInitializerRHI& Initializer);

	extern RHI_API FRHIRasterizerState*		GetAndOrCreateRasterizerState(const FRasterizerStateInitializerRHI& Initializer);

	extern RHI_API FRHIDepthStencilState*	GetAndOrCreateDepthStencilState(const FDepthStencilStateInitializerRHI& Initializer);
