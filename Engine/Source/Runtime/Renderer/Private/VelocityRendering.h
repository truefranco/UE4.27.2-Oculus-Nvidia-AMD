...
public:
	...
	// AppSpaceWarp
	static bool PrimitiveCanHaveVelocity(EShaderPlatform ShaderPlatform, bool AllowStatic, const FPrimitiveSceneProxy* PrimitiveSceneProxy);

	/** Returns true if the primitive has velocity for the current frame. */
	// AppSpaceWarp
	static bool PrimitiveHasVelocityForFrame(bool AllowStatic, const FPrimitiveSceneProxy* PrimitiveSceneProxy);
