...
struct FGfxPipelineDesc
{
	...
	struct FRenderTargets
	{
		struct FAttachmentRef
		{
			...
			void ReadFrom(const VkAttachmentReference2& InState);
			void WriteInto(VkAttachmentReference2& OutState) const;
		...
		struct FAttachmentDesc
		{
			...
			void ReadFrom(const VkAttachmentDescription2& InState);
			void WriteInto(VkAttachmentDescription2& OutState) const;
		};
