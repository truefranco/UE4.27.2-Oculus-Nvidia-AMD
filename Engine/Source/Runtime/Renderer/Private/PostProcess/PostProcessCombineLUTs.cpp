...
public:
	...
	static void ModifyCompilationEnvironment(const FGlobalShaderPermutationParameters& Parameters, FShaderCompilerEnvironment& OutEnvironment)
	{
		...
		static auto* MobileTonemapSubpassCvar = IConsoleManager::Get().FindTConsoleVariableDataInt(TEXT("r.Mobile.TonemapSubpass"));
		OutEnvironment.SetDefine(TEXT("TONEMAP_SUBPASS"), MobileTonemapSubpassCvar->GetValueOnAnyThread() == 1);
	}
