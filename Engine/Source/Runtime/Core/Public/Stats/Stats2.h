...
#define STATID_DESCRIPTION_STRING (InStatId.GetStatDescriptionANSI())
#else
#define STATID_DESCRIPTION_STRING (InStatId.GetStatDescriptionWIDE())
#endif

#if PLATFORM_IMPLEMENTS_BeginNamedEventStatic
			FPlatformMisc::BeginNamedEventStatic( FColor( 0 ), STATID_DESCRIPTION_STRING);
#else
			FPlatformMisc::BeginNamedEvent( FColor( 0 ), STATID_DESCRIPTION_STRING);
