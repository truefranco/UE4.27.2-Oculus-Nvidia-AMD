...
bool UDynamicMeshComponentToolTarget::IsValid() const
{
	...
	USimpleDynamicMeshComponent* DynamicMeshComponent = Cast<USimpleDynamicMeshComponent>(Component);
...
USimpleDynamicMeshComponent* UDynamicMeshComponentToolTarget::GetDynamicMeshComponent()
{
...
{
	return IsValid() ? Cast<USimpleDynamicMeshComponent>(Component)->GetBodySetup() : nullptr;
}


IInterface_CollisionDataProvider* UDynamicMeshComponentToolTarget::GetComplexCollisionProvider() const
{
	return IsValid() ? Cast<USimpleDynamicMeshComponent>(Component) : nullptr;
}
...
{
	USimpleDynamicMeshComponent* Component = Cast<USimpleDynamicMeshComponent>(SourceObject);
	return Component 
...
UToolTarget* UDynamicMeshComponentToolTargetFactory::BuildTarget(UObject* SourceObject, const FToolTargetTypeRequirements& Requirements)
{
	...
	Target->InitializeComponent(Cast<USimpleDynamicMeshComponent>(SourceObject));
