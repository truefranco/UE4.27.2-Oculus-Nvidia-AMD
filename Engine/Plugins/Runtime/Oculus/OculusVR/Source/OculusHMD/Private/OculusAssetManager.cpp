...
FSoftObjectPath FOculusAssetDirectory::AssetListing[] =
{
	...
	FString(TEXT("/OculusVR/Meshes/ScenePlane.ScenePlane")),
	FString(TEXT("/OculusVR/Meshes/SceneVolume.SceneVolume"))
};
...
#if PLATFORM_ANDROID
		{ ovrpNode_HandLeft,  ovrpSystemHeadset_Oculus_Quest, ovrpSystemHeadset_Meta_Quest_3, FOculusAssetDirectory::AssetListing[3] },
		{ ovrpNode_HandRight, ovrpSystemHeadset_Oculus_Quest, ovrpSystemHeadset_Meta_Quest_3, FOculusAssetDirectory::AssetListing[4] },
#else 
		{ ovrpNode_HandLeft,  ovrpSystemHeadset_Rift_S, ovrpSystemHeadset_Meta_Link_Quest_3, FOculusAssetDirectory::AssetListing[3] },
		{ ovrpNode_HandRight, ovrpSystemHeadset_Rift_S, ovrpSystemHeadset_Meta_Link_Quest_3, FOculusAssetDirectory::AssetListing[4] },
